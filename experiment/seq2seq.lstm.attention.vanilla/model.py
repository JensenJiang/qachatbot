...
class GANBasicModel(Seq2SeqBasicModel):
    ...
    def discriminator(self):
        ...
        self.true_score = self.seq2logit(self.true_ans,self.config.keep_prob,max_time_step=max_time_step)
        self.fake_score = self.seq2logit(self.true_ans, self.config.keep_prob, max_time_step=max_time_step,reuse=True)
